...
public class StudentMain {
    public static void main(String[] args) {
        ...
        System.out.println("Enter StudentMain.Student's Id:");
        studentId = sc.nextInt();

        System.out.println("Enter StudentMain.Student's Name:");
        studentName = sc.nextLine();

        System.out.println("Enter StudentMain.Student's Address:");
